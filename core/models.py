...
class UserManager(BaseUserManager):
    def create_user(self, phone, password=None, password2=None, **extra_fields):
        if not phone:
...
class User(AbstractUser):
    ...
    gender= models.CharField(choices=[('male','مرد'),('famel','زن')], max_length=5 ,blank=True,null=True)
